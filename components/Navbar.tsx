...
const Navbar = () => {
  ...
  alignItems="center">
        <Link href="/">
            <Button variant="outlined" style={{color: '#ffffff'}}>Feed</Button>
         </Link>
         <Link href="/enter">
              <Button variant="outlined" style={{color: '#ffffff'}}>Log in</Button>
            </Link></Grid></> : <>
    ...
    >
      ...
      <MenuItem onClick={()=>handleClose('/client/personal-bests')}>
             Personal bests
      </MenuItem>
